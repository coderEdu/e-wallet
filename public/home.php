<?php include "includes/header.php" ?>
    <div class="container flex flex-col w-full h-screen mx-auto bg-default">
        ...
        <h1 class="flex flex-row text-lg sm:text-xl w-fit mx-auto content-center p-8 lg:p-10 text-slate-900">Bienvenido a tu Billetera Electrónica.</h1>

        <!-- account list -->
        <div class="flex flex-col mb-5 sm:flex-row sm:flex-wrap w-full content-between items-center rounded-2xl">
            <div class="flex w-full h-32 sm:w-[47.5%] md:w-[31.2%] lg:w-[23.4%] xl:w-[23.7%] 2xl:w-[23.9%] m-2 rounded-2xl bg-slate-400">
                <div>
                    <div>
                        <p></p>
                        <h2><i></i></h2>
