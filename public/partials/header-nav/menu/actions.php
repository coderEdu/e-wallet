<div class="relative" x-data="{ open: false }">
    ...
    >
        <span>Transacciones</span><i class="ml-2 las la-angle-down"></i>
    </button>
        ...
        <div class="overflow-hidden bg-yellow-400 border shadow-xl rounded-2xl dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
            <div class="relative w-full flex flex-col px-0 py-3 space-y-8">
                <ul class="space-y-0 text-sm">
                    <li><a href="#" class="block pl-3 hover:bg-amber-500 py-2">Depositar</a></li>
                    <li><a href="#" class="block pl-3 hover:bg-amber-500 py-2">Extraer</a></li>
                    <li><a href="#" class="block pl-3 hover:bg-amber-500 py-2">Transferir</a></li>
                </ul>
            </div>
        </div>
    </div>
